...
import { saveClinicInfoService } from "../../../services/clinicService";
...
class ManageClinic extends Component {
  ...
  handleSubmit = async () => {
    if (this.validate().isValid) {
      const resp = await saveClinicInfoService(this.state.submitInfo);
    ...
    return (
      <div className="manage-specialty-container">
        <div className="container">
          <div className="title my-5">Quản lí phòng khám</div>
            ...
            <div className="row mb-5">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <input
                    value={this.state.submitInfo.address}
                    onChange={this.handleInputChange}
                    type="text"
                    name="address"
                    className="form-control"
